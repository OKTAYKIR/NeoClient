...
namespace NeoClient.Extensions
{
    public static class ObjectExtensions
    {
        ...
        internal static dynamic AsPartialUpdateClause(this object source, string prefix)
        {
            dynamic properties = new ExpandoObject();
            bool firstNode = true;
            StringBuilder clause = new StringBuilder();
            ...
            {
                if (prop.GetCustomAttribute(typeof(NotMappedAttribute), true) != null ||
                    prop.GetCustomAttribute(typeof(RelationshipAttribute), true) != null || prop.GetValue(source, null) == null)
                    continue;
        ...
        internal static string NameOf<TModel, TProperty>(this object @object, Expression<Func<TModel, TProperty>> propertyExpression)
        {
